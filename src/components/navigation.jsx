      ...
      <div className="container">
        ...
        >
          <ul className="nav navbar-nav navbar-right">
            ...
            <li>
              <a href="#offer" className="page-scroll" onClick={clearUrl}>
                {content.block3}
              </a>
            </li>
            <li>
              <a href="#fleet" className="page-scroll" onClick={clearUrl}>
                {content.block2}
              </a>
            </li>
            <li>
              <a href="#gallery" className="page-scroll" onClick={clearUrl}>
                {content.block4}
              </a>
            </li>

            <li>
              <a href="#contact" className="page-scroll" onClick={clearUrl}>
                {content.block5}
              </a>
            </li>
          </ul>
