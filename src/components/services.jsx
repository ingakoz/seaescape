...
export const Services = (props) => {
  let content = {
    ...
    Polski: {
      block1: "Oferta",
      block2:
        "Jesteśmy dumni, że możemy zapewnić wyjątkowe doświadczenia, które zaspokoją każde morskie pragnienie. Niezależnie od tego, czy szukasz krótkiej wycieczki morskiej, czy dłuższego czarteru, nasza oferta została zaprojektowana tak, aby przekroczyć Twoje oczekiwania.",
      block3: "Wycieczki 1-dniowe: Dzień luksusu na otwartym morzu",
      block4:
        "Dla tych, którzy pragną szybkiej ucieczki, nasze jednodniowe wycieczki zapewniają idealną dawkę luksusu i relaksu. Rejsuj wzdłuż malowniczych wybrzeży, zwiedzaj zaciszne zatoczki i zanurz się w spokoju otwartego morza. Zapewniamy profesjonalną kadrę skipperów, którzy z przyjemnością zabiorą Was w zaskakujące zakątki chorwackich wysp.",
      ...
      <div className="container">
        <div className="section-title">
          ...
          <div className="box-wycieczka">
            <h3 className="wycieczki">
              {" "}
              <FontAwesomeIcon className="my_icon" icon={faAnchorCircleCheck} />
              {content.block3}
            </h3>
            <div className="row">
              <div className="portfolio-items">
                {props.data ? (
                  <Fragment>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4">
                      <Image
                        largeImage={props.data[10].largeImage}
                        smallImage={props.data[10].smallImage}
                      />
                    </div>
                    <div className="col-sm-6 col-md-4 col-lg-4">
                      <Image
              ...
              <div className="portfolio-items">
                {props.data ? (
                  <Fragment>
                    <div className="col-sm-6 col-md-4 col-lg-4">
                      <Image
                        largeImage={props.data[11].largeImage}
                        smallImage={props.data[11].smallImage}
                      />
                    </div>
                    <div className="col-sm-6 col-md-4 col-lg-4">
                      <Image
                        largeImage={props.data[12].largeImage}
                        smallImage={props.data[12].smallImage}
                      />
                    </div>
                    <div className="col-sm-6 col-md-4 col-lg-4">
                      <Image
                        largeImage={props.data[13].largeImage}
                        smallImage={props.data[13].smallImage}
                      />
                    </div>
                  </Fragment>
                ) : (
